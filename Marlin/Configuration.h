...
#define STRING_CONFIG_H_AUTHOR "(Aaron DeLyser, Folgertech FT-5 SKR)" // Who made the changes.
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS / 2), Y_MIN_POS, 10 }
